...
> **brandvoice — multi-tenant RAG editorial platform**
>
...
>
> The name is the differentiator: a per-brand corpus is what makes the draft sound like that
> brand instead of like a generic model. Renamed from `quill` on 2026-09-06.
